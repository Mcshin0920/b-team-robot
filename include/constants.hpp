...
constexpr int32_t FLYWHEEL_VOLTAGES[3] = {7500, 10500};  // constant flywheel velocities to choose from
...
constexpr int32_t INTAKE_VELOCITY = 600; // intake motor velocity
}  // namespace constants
